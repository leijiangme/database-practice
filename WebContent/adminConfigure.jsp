    ...
    <body>
        <div style="width:1000px; margin:0 auto;">
            ...
            <div style="width:800px;float:right;">
                <form name="maxCourse" method="post" action="MaxCourses">
                    Policy:<br/>
                    MaxClassSize:<br>
                    <input type="text" name="maxClassSize" STYLE="background:#d6eaf8"/><br>
                    MaxCourseSem:<br>
                    <input type="text" name="maxCourseSem" STYLE="background:#d6eaf8"/><br>
